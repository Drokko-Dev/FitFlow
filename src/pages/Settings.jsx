  ...
  return (
    <div className="min-h-screen bg-bg pb-24">
      ...
      <header className="px-5 pt-[52px] pb-4">
        <h1 className="font-display text-[26px] font-extrabold text-[#f0eeff]">Configuración</h1>
      </header>
      ...
      {/* Cuenta */}
      <section className="px-5 mt-5">
        <h2 className="font-display text-[11px] font-semibold text-muted uppercase tracking-[0.1em] mb-1">Cuenta</h2>
        <div className="bg-card rounded-2xl border border-border px-4">
          <button
            onClick={showProximo}
